...
class Data:
            ...
            if mymachine.allotment_done== True:
                ...
                with open("datasheet.csv",'r') as f:
                    ...
                    with use_scope("main", clear=True):
                        ...
                        input('SRMJEE Marks', name='marks', type=NUMBER, required=True, help_text="Enter score out of 200.",validate=check_cet),
                        file_upload(label="SRMJEE Scorecard", accept=".pdf", name='cet_score_file',max_size='10M', placeholder="choose a file")
                        ],)
    ...
    def student_sign_up(self):
        ...
        signup_img = open('images/sign_up_img.png', 'rb').read()
        with use_scope("main", clear=True):
             put_image(header_img, width='100%', height='50px', position=0)
             put_html("<br>")
             put_html("<br>")
             ...
             data = input_group("Student Sign Up",[input('Enter your First Name', type=TEXT, name='name',required=True), input('Enter your Last Name', name='surname', type=TEXT, required=True)])
